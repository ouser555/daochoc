...
* Q4:撥桿開關斷掉了，請問型號
  ...
  A:這麼薄的開關，選料上已經盡量找強度較高的料件了，但是沒有永遠不會壞掉的零件。如果你要自行購買可以參考這個網址
  
    https://item.taobao.com/item.htm?spm=a1z0d.6639537/tb.1997196601.4.1ef27484LRialD&id=45244887058
    
    選強度較高的米白色，3mm的長度會比較容易操作。  
